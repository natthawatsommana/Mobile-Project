...
class Normal_Last extends StatefulWidget {
  final int finalScore; // เพิ่มการเก็บค่า finalScore

  const Normal_Last({super.key, required this.finalScore}); // Constructor

  @override
  _Normal_LastState createState() => _Normal_LastState();
}

class _Normal_LastState extends State<Normal_Last> {
  String? Value1_1;
  String? Value1_2;
  String? Value1_3;
  String? Value2_1;
                  ...
                  ElevatedButton(
                    onPressed: () {
                      ...
                      List<String> userAnswers = [
                        ...
                        Value1_2 ?? '',
                        Value1_3 ?? '', // ถ้าเป็น null จะใส่เป็นค่าว่าง
                        Value2_1 ?? '',
                        Value2_2 ?? '',
                        Value2_3 ?? '',
                        Value3_1 ?? '',
                      ...
                      int score = answer.scoreForNormal_3();
                      int finalScore = widget.finalScore +
                          score; // บวกคะแนนใหม่เข้ากับคะแนนก่อนหน้า

                      // แสดงป๊อปอัพที่แสดงคะแนน $score ก่อน
                      showDialog(
                        context: context,
                        barrierDismissible:
                        ...
                        builder: (context) {
                          return AlertDialog(
                            ...
                            content: Column(
                              ...
                              children: [
                                const Text(
                                  "คะแนนในด่านที่ 3", // ข้อความแสดงหัวข้อคะแนน
                                  style: TextStyle(
                            ...
                            actions: [
                              TextButton(
                                onPressed: () {
                                  // ปิดป๊อปอัพ $score และแสดงป๊อปอัพ $finalScore
                                  Navigator.of(context).pop();

                                  // แสดงป๊อปอัพที่แสดง $finalScore
                                  showDialog(
                                    context: context,
                                    ...
                                    builder: (context) {
                                      return AlertDialog(
                                        ...
                                        content: Column(
                                          ...
                                          children: [
                                            const Text(
                                              "คะแนนรวมทั้งหมด", // ข้อความแสดงหัวข้อคะแนน
                                              style: TextStyle(
                                                fontSize:
                                                    24, // ขนาดตัวอักษรใหญ่ขึ้น
                                            ...
                                            const SizedBox(
                                              height:
                                                  10, // เพิ่มช่องว่างระหว่างข้อความ
                                            ),
                                            Text(
                                              "$finalScore/36", // แสดงคะแนนรวม
                                              style: const TextStyle(
                                                fontSize:
                                                    36, // ขนาดตัวเลขใหญ่ขึ้น
                                                fontWeight: FontWeight
                                                    .bold, // ทำให้ตัวหนา
                                        ...
                                        actions: [
                                          TextButton(
                                            onPressed: () {
                                              // ปิดป๊อปอัพแล้วนำไปยังหน้าถัดไป
                                              Navigator.of(context).pop();
                                              Navigator.push(
                                                context,
                                                MaterialPageRoute(
                                                    builder: (context) =>
                                                        ModeScreen()), // เปลี่ยนเป็นหน้า ModeScreen
                                              );
                                              answer.finalScore =
                                                  0; // รีเซ็ตคะแนน
                                            },
