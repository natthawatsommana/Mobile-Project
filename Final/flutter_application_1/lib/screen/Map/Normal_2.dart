...
import 'package:flutter_application_1/screen/Map/Normal_Last.dart';
import 'package:flutter_application_1/screen/Mode.dart';

class Normal_2 extends StatefulWidget {
  final int finalScore; // รับคะแนนจากด่านแรก

  const Normal_2({super.key, required this.finalScore});

  @override
  _Normal_2State createState() => _Normal_2State();
}

class _Normal_2State extends State<Normal_2> {
  String? Value1_1;
  String? Value1_2;
  String? Value1_3;
  String? Value2_1;
                ...
                children: [
                  TableRow(
                    ...
                    children: const [
                      ...
                      Column(children: [
                        Text('~Q → P', style: TextStyle(fontSize: 20))
                      ]),
                      Column(children: [
                        Text('(~Q → P) ^ Q', style: TextStyle(fontSize: 20))
                      ]),
                    ],
                  ),
                  TableRow(
                ...
                children: [
                  ...
                  ElevatedButton(
                    onPressed: () {
                      ...
                      int score = answer.scoreForNormal_2();
